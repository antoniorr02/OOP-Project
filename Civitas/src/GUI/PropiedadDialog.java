...
public class PropiedadDialog extends javax.swing.JDialog {
     ...
     */
    public PropiedadDialog(Jugador jugador, java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        propiedadElegida = -1;
        j = jugador;
        ...
        ArrayList<CasillaCalle> opciones = j.getPropiedades();
        for (CasillaCalle s: opciones){
            p.addElement(s.toString());
        }
        propiedades.setModel(p);
        ///////////////////////////////////////////
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Propiedad sobre la que realizar la gestión:");
